  ...
  return (
    <PageContainer>
      ...
      <div className="mb-5 flex items-start gap-3 rounded-lg border border-info/30 bg-info-soft/60 p-3 text-sm text-info-fg" role="note">
        ...
        <p>
          <strong>Integração do WhatsApp em preparação.</strong> Por enquanto as respostas são simuladas (provedor de teste): ficam registradas no histórico do lead e na
          timeline do cliente, mas nenhuma mensagem sai do sistema. A WhatsApp Business API será conectada depois, sem mudar esta tela.
        </p>
      </div>
      <InboxView data={data} currentUserId={user.id} />
    </PageContainer>
  );
}
