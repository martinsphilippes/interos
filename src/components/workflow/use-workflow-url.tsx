...
/**
 * Estado do Workflow na URL (view, filtros, etapa aberta).
 * - `setLocal`: só troca a URL (History API); filtros client-side ficam compartilháveis sem recarregar.
 * - `navigate`: navegação real (o servidor recarrega dados): etapa aberta no drawer.
 */
