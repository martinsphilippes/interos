...
/**
 * Atingimento de um indicador contra a meta da regra de bônus. Mesma regra de `computeAttainment` do motor
 * de indicadores (src/server/kpis/engine.ts): maior_melhor = valor/meta; menor_melhor = meta/valor (limitado
